...
<body>
				...
				<table class="table">
					...
					<tr v-if ="filecount!=0">
						...
						<td colspan="3">
							<ul>
								...
								<a :href="'../databoard/download.do?fn='+fn">{{fn}}&nbsp;({{filesizes[index]}}bytes)</a></li>
					...
					<tr>
						<td colspan="4" class="text-left" valign="top" height="200">
							<pre style="white-space:pre-wrap; background-color:white;border:none;">{{detail_data.content}}
							</pre>
						</td>
					</tr>
					<tr>
	...
	<script>
		let app=Vue.createApp({
				...
				mounted(){
					axios.get("../databoard/detail_vue.do",{params:{no:this.no}})
					.then(response=>{
